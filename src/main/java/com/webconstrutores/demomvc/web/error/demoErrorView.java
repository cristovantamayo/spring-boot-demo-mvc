package com.webconstrutores.demomvc.web.error;
...
@Component
public class demoErrorView implements ErrorViewResolver {
	...
	public ModelAndView resolveErrorView(HttpServletRequest request, HttpStatus status, Map<String, Object> map) {
		...
		switch (status.value()) {
			...
			case 500:
				...
				model.addObject("message", "Erro inesperado, tente acessar mais tarde.");
				break;
